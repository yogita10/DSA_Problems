...
public class l005_viewSet {
    ...
    public static ArrayList<ArrayList<Integer>> verticalOrder(TreeNode root) {
        ...
        que.addLast(new vpair(root, Math.abs(minMax[0])));  // change this line if we want to changes in any of these derivative questions  
    ...
    public static ArrayList<ArrayList<Integer>> VerticalOrder_ii(TreeNode root) {
        ...
        for (int i = 0; i < width; i++)
            ...
            // hw -  implement this  - this is incomplete 
        PriorityQueue<v2pair> que = new PriorityQueue<>();   // implement this priority queue using coparable function on the basis of hl and vl 
