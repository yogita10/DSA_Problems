...
public class l003TraversalSet {
        ...
        while (curr != null) {
            ...
            if (left == null) {
                ...
                if (rightMostNode.right == null) { // thread creation block
                    ...
                    ans.add(curr.val);    //only change in preorder traversal 
                    curr = curr.left;
                } else { // thread destroy block
                    rightMostNode.right = null; // thread is cut down
                    curr = curr.right;
    ...
    // Kth largest ele - hw - reverse morris traversal 

    // covert bst to sorted circular doubly linkedlist -  on pepcoding portal  
